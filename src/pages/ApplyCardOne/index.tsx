...
const ApplyCardOnePage: React.FC = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-100_02 flex flex-col font-opensans items-center justify-start mx-auto pb-[37px] w-full">
            ...
            <div className="bg-white-A700 flex md:flex-col flex-row gap-4 items-start justify-start max-w-[1128px] mx-auto px-20 md:px-5 py-16 rounded-[12px] shadow-bs2 w-full">
              ...
              <div className="flex flex-1 flex-col gap-6 items-start justify-start max-w-[771px] w-full">
                ...
                <div className="flex flex-col gap-4 items-start justify-start w-auto sm:w-full">
                  <div className="flex flex-col gap-1 items-start justify-start pb-2 w-[377px] sm:w-full">
                    <Text
...
export default ApplyCardOnePage;
