...
type ApplyCardOneColumninputtextOneProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "userdate"
> &
  Partial<{ userdate: string }>;

const ApplyCardOneColumninputtextOne: React.FC<
  ApplyCardOneColumninputtextOneProps
> = (props) => {
  return (
    <>
...
ApplyCardOneColumninputtextOne.defaultProps = { userdate: "10/19" };

export default ApplyCardOneColumninputtextOne;
