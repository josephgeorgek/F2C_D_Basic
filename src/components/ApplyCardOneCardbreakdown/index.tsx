...
type ApplyCardOneCardbreakdownProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "username" | "remove" | "helpertextTwo"
> &
  Partial<{ username: string; remove: string; helpertextTwo: string }>;

const ApplyCardOneCardbreakdown: React.FC<ApplyCardOneCardbreakdownProps> = (
  props,
) => {
  return (
    <>
            ...
            <div className="flex md:flex-col flex-row gap-4 items-start justify-start w-full">
              <div className="flex flex-1 flex-col gap-1 h-[81px] md:h-auto items-start justify-start w-full">
                <div className="bg-white-A700 border border-blue_gray-100 border-solid flex flex-col items-center justify-start px-4 py-[5px] rounded-lg w-full">
                  <FloatingInput
                    wrapClassName="placeholder:bg-white-A700 font-opensans font-semibold placeholder:left-[0] p-0 sm:pr-5 text-base placeholder:text-blue_gray-500_02 text-blue_gray-800 text-left placeholder:top-[0] w-full"
...
ApplyCardOneCardbreakdown.defaultProps = {
  username: "Card 2 - Daniel Lim See Gan",
  remove: "Remove",
  helpertextTwo: "9/19",
};

export default ApplyCardOneCardbreakdown;
