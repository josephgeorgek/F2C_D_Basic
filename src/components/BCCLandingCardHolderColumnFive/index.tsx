          ...
          <div className="flex flex-col relative w-full">
            ...
            >
              <div className="flex flex-col gap-[22px] items-center justify-start w-full">
                <Line className="bg-gradient1  h-1.5 w-full" />
            ...
            <div className="bg-gradient2  border border-gray-300_5f border-solid flex flex-col items-center justify-start mt-[-26px] mx-auto p-[15px] rounded-[5px] shadow-bs1 w-[67%] z-[1]">
